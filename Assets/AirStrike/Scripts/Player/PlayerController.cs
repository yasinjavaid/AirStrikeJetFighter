...
public class PlayerController : MonoBehaviour
{
    ...
    void MobileController()
    {
        ...
        else
        {
            ...
            Vector2 dir = JoyStick.GetTouchPosition;//Yasin controllerTouch.OnDragDirection (true);
            //SimpleTouchController

            dir = Vector2.ClampMagnitude(dir, 1.0f);
            //Turn Update 
           
            flight.AxisControl(new Vector2(dir.x, -dir.y) * 0.7f);
            flight.TurnControl(JoyStick.GetTouchPosition.x);
            //yasin flight.AxisControl(new Vector2(dir.x, -dir.y) * AccelerationSensitivity * 0.7f);
            //Yasin  flight.TurnControl(dir.x * AccelerationSensitivity * 0.3f);
        }
